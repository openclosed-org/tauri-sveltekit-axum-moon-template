...
function printOptimizationTips(): void {
  ...
  if (sccache) {
    console.log(
      "[dev-desktop] âœ?sccache enabled (compilation caching active)",
    );
  } else {
    console.log(
      "[dev-desktop] âš?sccache NOT enabled â€?run: just setup-sccache",
    );
  }

  if (hakari) {
    console.log(
      "[dev-desktop] âœ?cargo-hakari enabled (unified dependency resolution)",
    );
  } else {
    console.log(
      "[dev-desktop] âš?cargo-hakari NOT enabled â€?run: just setup-hakari",
    );
  }
  console.log("");
}
...
function cleanup(
  ...
  if (tauriProcess) {
    console.log(
      "[dev-desktop] Stopping Tauri (this will also stop its child processes)...",
    );
...
async function main(): Promise<void> {
  ...
  console.log(
    "[dev-desktop] (First run may take a while to compile surrealdb-core)",
  );
  ...
  if (!apiReady) {
    console.warn(
      "[dev-desktop] WARNING: API server not ready yet, but starting Tauri anyway...",
    );
    console.warn(
      "[dev-desktop] API server will continue compiling in background...",
    );
  }
  console.log("");
  ...
  console.log(
    "[dev-desktop] Tauri will start the SvelteKit frontend automatically...",
  );
  console.log("");
  ...
  console.log(
    "[dev-desktop] Tauri window: should appear after Rust compilation",
  );
  console.log("");
