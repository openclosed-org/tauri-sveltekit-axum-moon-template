...
> Historical launch note. Useful for project context, but not a current-state source of truth.
...
5. `docs/adr/009-canonical-monolith-first-topology-late-backend.md`
